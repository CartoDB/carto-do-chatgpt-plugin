...
import uuid
from models.models import Document, DocumentChunk, DatasetMetadata, DatasetChunkMetadata, VariableMetadata, VariableChunkMetadata
...
def create_document_chunks(
    ...
    # check if metadata is VariableChunkMetadata or DocumentChunkMetadata
    if isinstance(doc.metadata, DatasetMetadata):
        cls = DatasetChunkMetadata
    elif isinstance(doc.metadata, VariableMetadata):
        cls = VariableChunkMetadata

    metadata = (
        cls(**doc.metadata.__dict__)
